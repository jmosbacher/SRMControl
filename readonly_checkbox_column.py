...
if ETSConfig.toolkit == 'wx':
    ...
    from traitsui.qt4.extra.checkbox_renderer import CheckboxRenderer
else:
...
class Renderer(CheckboxRenderer):
...
class ReadOnlyCheckboxColumn(ObjectColumn):
    ...
    def __init__(self, **traits):
        """ Initializes the object.
        """
        super(ReadOnlyCheckboxColumn, self).__init__(**traits)
